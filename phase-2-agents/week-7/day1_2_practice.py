    ...
    for iteration in range(max_iterations):
        ...
        if parsed["action"]:
            ...
            if tool_name == "web_search":
                observation = web_search(tool_input["query"])
            elif tool_name == "calculator":
                observation = str(calculator(**tool_input))
            elif tool_name == "save_to_file":
                observation = save_to_file(**tool_input)
            else:
...
# Test 2
# result = run_agent("Search for China gdp and USA population. Calculate the difference in gdp for these 2 countries. Save the result.")
# print(result)

# Test 3
# result = run_agent("Search for Tesla stock and Apple stock. Calculate the difference in stock for these 2 companies. Save the result.")
# print(result)
