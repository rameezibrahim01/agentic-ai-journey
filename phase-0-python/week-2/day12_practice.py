...
print("•	Custom validation: write age_input() that raises ValueError if age < 0 or > 150.")

def age_input():
    try:
        age = int(input("Enter the age: "))
    except ValueError:
        raise ValueError("Error: Age should be a number")    
            
    if age < 0 or age > 150:
        raise ValueError("age cannot be less than 0 or more than 150")
